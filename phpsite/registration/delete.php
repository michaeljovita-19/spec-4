...
if (isset($_GET['studid'])) {
    ...
    try {
        ...
        $sql = $conn->prepare("
            SELECT s.*, p.progfullname, c.collfullname
            FROM students s
    ...
    <?php if (isset($student)): ?>
        <div class="container">
            ...
            <form action="deleteprocess.php" method="post">
                ...
                <input type="text" id="program" name="program" value="<?php echo htmlspecialchars($student['progfullname']); ?>" readonly><br>

                <label for="college">College</label>
                <input type="text" id="college" name="college" value="<?php echo htmlspecialchars($student['collfullname']); ?>" readonly><br>
